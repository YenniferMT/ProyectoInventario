        ...
        <section id="productos">
            ...
            <div class="form_divCon">
                <form class="" action="" method="post">
                    ...
                    <div class="">
                        ...
                        <select class="form_selec" values="idcategoria" required>
                            ...
                            <?php
                                ...
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?php $datos->id_categoria ?>"><?php $datos->nombre_categoria ?></option>
                            <?php } ?>
                         </select>
                    </div>
                    <div class="">
                        ...
                        <select class="form_selec" values="idmarca" required>
                            ...
                            <?php
                                ...
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?php $datos->id_marca ?>"><?php $datos->nombre_marca ?></option>
                            <?php } ?>
                         </select>
                    </div>
                    <div class="">
                        ...
                        <select class="form_selec" values="idproveedor" required>
                            ...
                            <?php
                                ...
                                while($datos=$sql->fetch_object()){?>
                                <option value="<?php $datos->id_proveedor ?>"><?php $datos->nombres_proveedor; echo " "; $datos->apellidos_proveedor; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        <label  class="form-label">Presentacion del Producto</label><br>
                        <input type="file" class="form-control" name="fotoPres" id=""><br>
                            ...
                            <?php
                                ...
                                while($datos=$sql->fetch_object()){?>
                                    <tr>
                                        ...
                                        <td><?= $datos->foto_usuario ?></td>
                                        <td><?= $datos->contrasena_usuario ?></td>
                                        <td><?= $datos->id_rol ?></td>
                                        <td><a href=""class=""><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href=""class=""><i class="fa-solid fa-trash-can"></i></a></td>
                                    </tr>
